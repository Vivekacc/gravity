...
import { ColorsManager } from '/app/classes/Color'
...
export default class Page {
    ...
    constructor({
        ...
        this.selectorChildren = {
            ...
            animationsHightlights: '[data-animation="highlight"]',
    ...
    create(){
        ...
        createAnimations () {
            ...
            this.animationsHightlights = map(this.elements.animationsHightlights,(element) => {
             ...
             this.animations.push(this.animationsHightlights);
        ...
        onResize () {
            ...
            // each(this.animations, () => onResize())
            // tempSolution calling from local page only
        }
